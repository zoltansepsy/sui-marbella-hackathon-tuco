                  ...
                  {view === "home" && (
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Show My Posted Jobs for CLIENT profiles */}
                        ...
                        {/* Show My Portfolio for FREELANCER profiles with jobs */}
                        {profile?.profileType === ProfileType.FREELANCER && profile.activeJobsCount > 0 && (
